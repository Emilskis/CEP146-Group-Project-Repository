...
This folder should contain the scripts/transcripts for the global event portion of the group project.
This folder will be used to document this script.

## Script Main Points

**- Cyberattacks have become more advanced and descructive as technology advanced**
...
The expected cost of the damage was estimated to range from $4 billion - $8 billion globally.
